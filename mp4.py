...
async def index():
    ...
    for img in vid_reader.iter_data():
        ...
        img0 = cv2.imdecode(img_bgr, cv2.IMREAD_COLOR)
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--source', type=str, default='rtsp://127.0.0.1/test')  # file/folder, 0 for webcam
    parser.add_argument('--source', type=str,
                        default="d:\\Users\\HP\\Desktop\\project\\detect\\video\\rmat=flv480\\smoke.mp4")
